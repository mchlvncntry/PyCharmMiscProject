...
Reads data exclusively from: /users/abrick/resources/si.csv
Displays the top 20 roadways by default.
"""
...
# The assignment asks to produce a report, so I wrote a method to format the data
# to look like a nice report.
...
def main():
    ...
    top_n = 20 # required by the homework instructions
