...
with open('latin1sample.txt', 'w', encoding='latin-1') as f:
    f.write(text)

# Create a Windows-1252 encoded file
text = "Windows-1252 special chars: €, †, ‡, •, ™"
with open('windows1252sample.txt', 'w', encoding='windows-1252') as f:
    f.write(text)

# Create a UTF-16 encoded file
text = "UTF-16 encoding: Hello 世界 🌍"
with open('utf16sample.txt', 'w', encoding='utf-16') as f:
    f.write(text)

# Create a file with mixed/invalid UTF-8 bytes
with open('invalidutf8.txt', 'wb') as f:
